...
class VirtualCamParams(ParamGroup):
    ...
    def __init__(self, parser):
        ...
        # Illumination-aware / fold-aware scoring controls.
        self.search_ill_reweight = False
        self.search_ill_lambda = 0.0
        self.search_ill_patch = 11
        self.search_fold_penalty = False
        self.search_fold_tau_deg = 25.0
        self.search_fold_eta = 0.7
